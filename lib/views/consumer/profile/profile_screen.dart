      ...
      body: Obx(() {
        ...
        return ListView(
          ...
          children: [
            ...
            _MenuItem(icon: Icons.location_on, title: 'saved_addresses', onTap: () {}),
            _MenuItem(icon: Icons.history, title: 'order_history', onTap: () {}),
            _MenuItem(icon: Icons.favorite, title: 'favorites', onTap: () {}),
            _MenuItem(
              icon: Icons.language,
              title: 'language',
            ...
            _MenuItem(icon: Icons.description, title: 'terms_conditions', onTap: () {}),
            _MenuItem(icon: Icons.privacy_tip, title: 'privacy_policy', onTap: () {}),
            _MenuItem(icon: Icons.info, title: 'about_us', onTap: () {}),
            const SizedBox(height: 16),
